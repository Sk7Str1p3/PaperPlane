        ...
        commonArgs =
          ...
          let
            gtk4-papered = gtk4.overrideAttrs (prev: {
              patches = (prev.patches or [ ]) ++ [ ./build-aux/gtk-reversed-list.patch ];
            });
            wrapPaperHook = buildPackages.wrapGAppsHook3.override { gtk3 = gtk4-papered; };
            libadwaita-papered = libadwaita.override { gtk4 = gtk4-papered; };
          in
          {
            inherit src;
            strictDeps = true;
